...
public class Message {
    ...
    public final static String WAITING_FOR_PLAYER = "Wait for your opponent to pick his word...";
    public final static String WAITING_FOR_CONNECTION = "Wait for an opponent...";
    public final static String GAME_WILL_START = "The Game will start!!";
    public final static String CHOOSE_A_WORD = "Choose one word: ";
    ...
    public final static String NICE_GUESS = "You got it right!";
